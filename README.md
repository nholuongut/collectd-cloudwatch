...
## Installation
 * Download [installation script](https://github.com/nholuongut/collectd-cloudwatch/blob/master/src/setup.py), place it on the instance and execute it:
```
chmod u+x setup.py
sudo ./setup.py
```
...
2. Download your repository: `git clone https://github.com/nholuongut/collectd-cloudwatch`
